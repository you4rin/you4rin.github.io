...
　이 점을 이용하여 **비트dp**를 돌리면 \\( O(N 2^{2M}) \\) 에 해결이 가능합니다. 사실 N과 M 모두 최대 14라 최악의 경우 연산횟수가 40억까지 갈 수 있을 것처럼 보이지만, 실제로는 2x1 크기의 도미노를 배치하는 경우의 수가 2^M가지에 한참 못미쳐서 통과한 것 같습니다. 실제로 로컬에서도 14 14가 몇 초 안에 돌기도 해서 믿음의 제출을 할 수 있었습니다.
...
　티어: **<font color='#27e2a4'>플레티넘 IV</font>**
...
　티어: **<font color='#2cffbc'>플레티넘 I</font>**
